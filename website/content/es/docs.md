...
Con **Auto-rename branch** habilitado en ajustes, el coding agent renombra tu branch para que coincida con la tarea en el primer prompt. Así `dy/coral-tidal-reef` se convierte en `dy/fix-login-timeout`.
